## backyards mtls allow

Set mTLS policy setting for a resource to PERMISSIVE
...
```
backyards mtls allow [[--resource=]mesh|namespace|namespace/servicename[:[portname|portnumber]]] [flags]
```
