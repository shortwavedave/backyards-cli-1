...
TURBONOMIC_IMPORTER_CHART_VERSION="0.1.7"
...
CHARTS+=("https://kubernetes-charts.banzaicloud.com/charts/turbonomic-importer-${TURBONOMIC_IMPORTER_CHART_VERSION}.tgz")
